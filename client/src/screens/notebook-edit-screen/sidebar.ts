    ...
    super({
      ...
      children: [
        ...
        $debugButton,
        {
          ...
          tag: 'button',
          class: <CssClass>'iconButton',
          attrs: { title: "Development Use Only"},
